...
|3. | Hierarchical models using limited data detected wake/sleep differences with 90% reliability | Classify wake vs. sleep states using the equivalent limited training data from a single channel: Fz HFB should discriminate states, whereas P3 HFB should not |
